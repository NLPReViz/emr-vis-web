...
for doc in docIds:
    ...
    for var in variables:
        ...
        if random.random() < 0.5:
            attributes['classification'] = "positive"
        else:
            attributes['classification'] = "negative"
        ...
        attributes['topPositive'] = [ 
                                        {"term": "pathology", "weight": weights[0]},
                                        {"term": "difficulty", "weight": weights[1]},
                                        {"term": "followup", "weight": weights[2]},
                                        {"term": "introduce", "weight": weights[3]},
                                        {"term": "prior", "weight": weights[4]}
                                    ]
        ...
        attributes['topNegative'] = [
                                        {"term": "indication", "weight": weights[0]},
                                        {"term": "impression", "weight": weights[1]},
                                        {"term": "small", "weight": weights[2]},
                                        {"term": "rectal", "weight": weights[3]},
                                        {"term": "mg", "weight": weights[4]}
                                    ]
